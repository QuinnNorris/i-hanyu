				...
				<div class="left-frame">
					<div class="card person">
						...
						<div class="card-content">
							<div class="card-item">
								<div class="card-item-c">用户名：<s:property value="#session.userInfo.userName()"></s:property></div>
								<div class="card-item-e">username：<s:property value="#session.userInfo.userName()"></s:property></div>
							</div>
							<div class="card-item">
								<div class="card-item-c">微信：<s:property value="#session.userInfo.phoneNumber"></s:property></div>
								<div class="card-item-e">Wechat：<s:property value="#session.userInfo.phoneNumber"></s:property></div>
							</div>
							<div class="card-item">
                                <div class="card-item-c">国家：<s:property value="#session.userInfo.getCountry().ch()"></s:property> </div>
                                <div class="card-item-e">country：<s:property value="#session.userInfo.getCountry().en()"></s:property></div>
							</div>
						</div>
					</div>
